...
@section('content')
    <div class="content-container">
        ...
        <section class="mb-10 lg:mb-16 home-one">
            <div>
        ...
        <section class="mb-20 home-two">
            ...
            <div id="package_slider" class="lg:grid lg:grid-cols-3 lg:gap-x-8 w-full -mx-3 equal-height-slider">
                ...
                <div class="rounded-lg mb-4 bg-[#E8EBF2]">
                    ...
                    <div id="collapseOne" class="!visible" data-twe-collapse-item data-twe-collapse-show
                        ...
                        <div class="px-5 py-4 text-[#4D5C99]">
                            FTTH stands for Fiber To The Home. It is a technology that uses optical fiber directly from the
                            central point to the residences. This provides significantly higher speeds and bandwidth
